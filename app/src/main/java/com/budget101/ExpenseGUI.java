...
import com.budget101.Data.Expense;
 ...
 * to input expense.
 */
public class ExpenseGUI extends MainActivity {
    ...
    private void populateCategories()
    {
        ...
        for(int i = 0; i < this.categories.length; i++)
        {
            ...
            if(this.categories[i].getMoney().equals(EXPENSE)) {
                this.expenseCat=this.categories;
