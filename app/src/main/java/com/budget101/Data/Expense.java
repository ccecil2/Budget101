...
/*
   Contains an expense object.
 */

    private Category category;
    private String comment; //leave a note for the expense category
     ...
     * @param comment - note for expense category
     * @param amount - amount of expense
     * @param date - date when transaction occurred
     */
    public Expense(Category cat, String comment, double amount, Date date)
    {
        this.category = cat;
